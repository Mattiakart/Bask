...
export function WaitlistSection() {
  return (
    <section
      id="join"
      className="relative scroll-mt-16 overflow-hidden border-t border-line/70"
    >
      <div
        aria-hidden="true"
      ...
      <div className="mx-auto max-w-2xl px-6 py-24 text-center lg:py-32">
        <Reveal>
          <p className="text-[10px] font-semibold uppercase tracking-[0.3em] text-accent-ink">
            Start with Bask
          </p>
          ...
          <p className="mx-auto mt-6 max-w-lg text-[1.0625rem] leading-relaxed text-ink-soft">
            Leave your email and we’ll open the door — quietly, without the noise.
          </p>
