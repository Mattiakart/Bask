    ...
    <div className="flex h-full flex-col px-5 pt-3">
      <div className="flex items-center gap-2.5 border-b border-line pb-3">
        ...
        <div className="flex-1">
          <p className="text-[12.5px] font-semibold tracking-tight text-ink">Bask Shopper</p>
      ...
      <div className="mt-4 space-y-3">
        <div className="max-w-[86%] rounded-2xl rounded-tl-md bg-[#eeece8] px-3.5 py-2.5">
        ...
        <div className="ml-auto w-fit max-w-[70%] rounded-2xl rounded-tr-md bg-ink px-3.5 py-2 text-right">
          <p className="text-[11.5px] text-bg">Certo!</p>
        </div>

        <div className="max-w-[92%] rounded-2xl rounded-tl-md bg-[#eeece8] px-3.5 py-2.5">
      ...
      <div className="mt-5 flex items-center gap-2 rounded-full bg-[#f1f0ee] px-4 py-2.5 ring-1 ring-line">
...
function ChatLook({
  ...
  kind: Parameters<typeof Garment>[0]["kind"];
  tone: Parameters<typeof Garment>[0]["tone"];
}) {
  return (
